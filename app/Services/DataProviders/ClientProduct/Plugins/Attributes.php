...
//                    }
    ...
    private function getIcon(Attribute\AllowedValue $value): string
    {
        return match ($value->attribute_id){
            ...
            Attribute\AttributeConstants::COUNT_KEYS_IN_SET_ID => $value->getSpriteSvgHtml('class="product-attribute-media" width="29" height="29"',  (int)$value->value <= 5 ? (int)$value->value : 5),
