...
final class CylinderFirstSizeLens extends ClassicListLens
{
    ...
    public function modifyQuery($query, $lensData)
    {
       ...
       if(empty($lensData[0])){
        ...
        $query->leftJoin(
            ...
            ->where("{$attrValuesAlias}_attr_all_val.value_first_size_cylinder", $lensData[0]);
