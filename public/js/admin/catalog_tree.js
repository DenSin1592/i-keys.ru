$(function () {
        ...
        (function(){
            ...
            // Show-hide handlers
            $(document).on('click', '.catalog-tree .list-toggle', function () {
                $(this).parents('.catalog-tree').eq(0).find('.list-container').eq(0).toggleClass('visible');
            });
            ...
            $(document).on('click', '.catalog-tree .category .category-toggle', function (e) {
                var self = $(this);
            ...
            $('.catalog-tree').on('change', '.category-select', function () {
            ...
            window.initElementsTree = function (parentContainer) {
                ...
                if (parentContainer === undefined) {
                    var rootContainer = $('.catalog-tree');
