...
<?php $__env->startSection('content'); ?>
    ...
    <div class="element-list-wrapper category-list" data-sortable-wrapper="">
        ...
        <?php echo $__env->make('admin.shared.resource_list.sorting._commit', ['updateUrl' => route('cc.categories.update-positions'), 'reloadUrl' => empty($category) ? route('cc.categories.index') : route('cc.categories.show', $category->id)], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kristinayudina/works/l-keys.ru_2021/www/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>