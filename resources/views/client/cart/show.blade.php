...
@section('modals')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="POST" data-method="POST" data-action="{{route('order.fast.store')}}" class="form-modal form" id="quick-order">

                        <div class="form-group">
                            <input type="text" class="form-control" name="name" id="form-quick-order-name" placeholder="Имя" >
                        </div>

                        <div class="form-group">
                            <input type="email" class="form-control" name="email" id="form-quick-order-email" placeholder="Почта *" required >
                        </div>

                        <div class="form-group">
                            <input type="tel" class="form-control" name="phone" id="form-quick-order-phone" placeholder="Телефон *" required >
                        </div>
    ...
    <div class="modal fade personal-info-modal" id="modalQuickOrderSuccess" tabindex="-1" role="dialog" aria-labelledby="modalQuickOrderSuccessLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="modal-title" id="modalQuickOrderSuccessLabel">Ваш заказ</div>
{{--                    @include('client.layouts.modals.shared._close_btn')--}}
                </div>
