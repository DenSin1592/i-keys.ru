    ...
    <form action="#" class="form-modal form">
        <div class="form-row">
            <div class="col-3 col-sm-2">
                <a href="{{\UrlBuilder::getUrl($product)}}" class="modal-thumbnail d-flex align-items-center justify-content-center">
            ...
            <div class="col-9 col-sm-10 align-self-center">
                <a href="{{\UrlBuilder::getUrl($product)}}" id="modalAddToCardProductName" class="title-h4 text-secondary">{!! $product->name !!}</a>
