...
@section('title')
    {{ $formData['category']->name }} - создание параметра
@stop
...
@section('content')
    ...
    {!! Form::tbModelWithErrors($formData['attribute'], $errors, ['url' => route('cc.attributes.store', $formData['category']->id), 'method' => 'post', 'files' => true, 'autocomplete' => 'off']) !!}
