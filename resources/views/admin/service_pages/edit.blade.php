...
@section('content')
    ...
    {!! Form::tbModelWithErrors($servicePage, $errors, ['url' => route('cc.service-pages.update', [$node->id]), 'method' => 'put', 'files' => true]) !!}
        ...
        @include('admin.shared._model_timestamps', ['model' => $servicePage])
